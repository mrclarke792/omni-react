  ...
  return (
    <>
      ...
      <div className="pricing-area pb-75">
        <div className="container">
          <Title sectionName={"Our Pricing"} sectionTitle={"Affordable Plans for You"} style={"style-2"} />
          <PricingGrid />
        </div>
      </div>
            ...
            <div className="col-lg-6">
              <div className="faq-content">
                <div className="title">
                  ...
                  <h2>Your Partner in Digital Transformation and Growth.</h2>
                </div>
                <p>Still have questions or need more details?</p>
                <h3>Discover how we can elevate your online presence with tailored digital strategies.</h3>
                <div className="icon">
              ...
              <div className="faq-questions">
                <div className="questions-content">
                  <div className="accordion" id="accordionExample">
                    {FaqDataOne.slice(0, 5).map(({ ans, id, question }) => (
                      <According key={id} ans={ans} id={id} parentId={"accordionExample"} question={question} showId={"two"} />
                    ))}
                  </div>
                </div>
              </div>
